#!/usr/bin/python3
#
# Title:       Important Security Announcement for qemu SUSE-SU-2023:3444-1
...
other_links = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2023-August/016033.html"
	...
	if ( server['DistroVersion'] == 15):
		if ( server['DistroPatchLevel'] == 3 ):
			packages = {
				...
				'qemu-arm-debuginfo': '5.2.0-150300.127.3',
			}
