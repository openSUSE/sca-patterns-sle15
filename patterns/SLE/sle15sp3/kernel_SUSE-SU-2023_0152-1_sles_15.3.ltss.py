#!/usr/bin/python3
#
# Title:       Important Security Announcement for Kernel SUSE-SU-2023:0152-1
...
other_links = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2023-January/013530.html"
	...
	if ( server['DistroVersion'] == 15):
		if ( server['DistroPatchLevel'] == 3 ):
			packages = {
				...
				'kernel-obs-build-debugsource': '5.3.18-150300.59.109.1',
				'kernel-syms': '5.3.18-150300.59.109.1',
				'reiserfs-kmp-default': '5.3.18-150300.59.109.1',
				'reiserfs-kmp-default-debuginfo': '5.3.18-150300.59.109.1',
			}
