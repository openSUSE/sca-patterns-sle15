#!/usr/bin/python3
#
# Title:       Important Security Announcement for Java SUSE-SU-2020:3591-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2020-December/007906.html"
...
if ( SERVER['DistroVersion'] == 15):
	if ( SERVER['DistroPatchLevel'] == 0 ):
		PACKAGES = {
			'java-1_8_0-openjdk': '1.8.0.275-3.45.1',
			'java-1_8_0-openjdk-debuginfo': '1.8.0.275-3.45.1',
			'java-1_8_0-openjdk-debugsource': '1.8.0.275-3.45.1',
			'java-1_8_0-openjdk-demo': '1.8.0.275-3.45.1',
			'java-1_8_0-openjdk-demo-debuginfo': '1.8.0.275-3.45.1',
