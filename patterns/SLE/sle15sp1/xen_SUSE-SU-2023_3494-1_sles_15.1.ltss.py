#!/usr/bin/python3
#
# Title:       Important Security Announcement for xen SUSE-SU-2023:3494-1
...
other_links = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2023-August/016051.html"
	...
	if ( server['DistroVersion'] == 15):
		if ( server['DistroPatchLevel'] == 1 ):
			packages = {
				...
				'xen-debugsource': '4.12.4_36-150100.3.89.1',
				'xen-devel': '4.12.4_36-150100.3.89.1',
				'xen-libs': '4.12.4_36-150100.3.89.1',
				'xen-libs-debuginfo': '4.12.4_36-150100.3.89.1',
				'xen-tools': '4.12.4_36-150100.3.89.1',
				'xen-tools-debuginfo': '4.12.4_36-150100.3.89.1',
				'xen-tools-domU': '4.12.4_36-150100.3.89.1',
				'xen-tools-domU-debuginfo': '4.12.4_36-150100.3.89.1',
			}
