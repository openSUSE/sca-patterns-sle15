#!/usr/bin/python3
#
# Title:       Important Security Announcement for webkit2gtk3 SUSE-SU-2022:0183-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2022-January/010071.html"
...
if ( SERVER['DistroVersion'] == 15):
	if ( SERVER['DistroPatchLevel'] == 1 ):
		PACKAGES = {
			...
			'libjavascriptcoregtk-4_0-18-debuginfo': '2.34.3-3.92.1',
			'libwebkit2gtk-4_0-37': '2.34.3-3.92.1',
			'libwebkit2gtk-4_0-37-debuginfo': '2.34.3-3.92.1',
			...
			'webkit2gtk-4_0-injected-bundles-debuginfo': '2.34.3-3.92.1',
			'webkit2gtk3-debugsource': '2.34.3-3.92.1',
