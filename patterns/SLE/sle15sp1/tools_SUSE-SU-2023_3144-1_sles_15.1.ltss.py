#!/usr/bin/python3
#
# Title:       Moderate Security Announcement for Tools SUSE-SU-2023:3144-1
# Description: Security fixes for SUSE Linux Enterprise 15 SP1 LTSS
# URL:         https://lists.suse.com/pipermail/sle-security-updates/2023-August/015736.html
...
other_links = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2023-August/015736.html"
	...
	if ( server['DistroVersion'] == 15):
		if ( server['DistroPatchLevel'] == 1 ):
			packages = {
				...
				'python2-tornado-debuginfo': '4.5.3-150000.3.6.1',
