#!/usr/bin/python
#
# Title:       Important Security Announcement for Kernel SUSE-SU-2020:3748-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2020-December/007964.html"
...
if ( SERVER['DistroVersion'] == 15):
	if ( SERVER['DistroPatchLevel'] == 2 ):
		PACKAGES = {
			...
			'kernel-default-devel-debuginfo': '5.3.18-24.43.2',
			'kernel-devel': '5.3.18-24.43.2',
			'kernel-macros': '5.3.18-24.43.2',
			'kernel-preempt': '5.3.18-24.43.2',
			'kernel-preempt-debuginfo': '5.3.18-24.43.2',
			'kernel-preempt-debugsource': '5.3.18-24.43.2',
		}
