...
OTHER_LINKS = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2021-January/008233.html"
...
if ( SERVER['DistroVersion'] == 15):
	if ( SERVER['DistroPatchLevel'] == 2 ):
		PACKAGES = {
			'gdk-pixbuf-debugsource': '2.40.0-3.3.1',
			'gdk-pixbuf-devel': '2.40.0-3.3.1',
			'gdk-pixbuf-devel-debuginfo': '2.40.0-3.3.1',
			'gdk-pixbuf-lang': '2.40.0-3.3.1',
			'gdk-pixbuf-query-loaders': '2.40.0-3.3.1',
			'gdk-pixbuf-query-loaders-debuginfo': '2.40.0-3.3.1',
			'gdk-pixbuf-thumbnailer': '2.40.0-3.3.1',
			'gdk-pixbuf-thumbnailer-debuginfo': '2.40.0-3.3.1',
			'libgdk_pixbuf-2_0-0': '2.40.0-3.3.1',
			'libgdk_pixbuf-2_0-0-debuginfo': '2.40.0-3.3.1',
